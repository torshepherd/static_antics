...
#ifndef GREP_FILE
#  error Usage: clang static_llama.cpp -std=c++2c -Wno-everything -fconstexpr-steps=10000000 -DWEIGHTS="path/to/weights/file" -DTOKENIZER="path/to/tokenizer/file" -DPROMPT="There once was a C compiler named "
